...
function printHelp () {
  echo "Usage: "
  echo "  eyfn2.sh up|down|restart|generate [-c <channel name>] [-t <timeout>] [-d <delay>] [-f <docker-compose-file>] [-s <dbtype>]"
  echo "  eyfn2.sh -h|--help (print this message)"
  ...
  echo
  echo "	eyfn2.sh generate -c mychannel"
  echo "	eyfn2.sh up -c mychannel -s couchdb"
  echo "	eyfn2.sh up -l node"
  echo "	eyfn2.sh down -c mychannel"
  echo
  echo "Taking all defaults:"
  echo "	eyfn2.sh generate"
  echo "	eyfn2.sh up"
  echo "	eyfn2.sh down"
}
